...
public class BroadcastManager implements AutoCloseable {
	...
	public void broadcast(byte[] message) throws IOException {
		try {
			...
			/*
			* Robots does not receive packets broadcast on 255.255.255.255.
			* 192.168.43.1/24 is the Wifi Tethering IP, this is hardcoded in Android sources:
			* https://github.com/android/platform_frameworks_base/blob/master/services/core/java/com/android/server/connectivity/Tethering.java
			* So the broadcast address is 192.168.43.255
			 */
